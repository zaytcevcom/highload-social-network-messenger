 ...
 */
final class Version20230529172317 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE conversation_message (id INT AUTO_INCREMENT NOT NULL, shard_id INT NOT NULL, conversation_id INT NOT NULL, user_id INT NOT NULL, text LONGTEXT NOT NULL, created_at INT NOT NULL, updated_at INT DEFAULT NULL, deleted_at INT DEFAULT NULL, INDEX IDX_CONVERSATION (conversation_id), INDEX IDX_USER (user_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
    }
